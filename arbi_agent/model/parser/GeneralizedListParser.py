...
class GeneralizedListParser ( Parser ):
    ...
    class Generalized_listContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterGeneralized_list" ):
                listener.enterGeneralized_list(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitGeneralized_list" ):
                listener.exitGeneralized_list(self)
    ...
    def generalized_list(self):
        ...
        try:
            ...
            self.state = 13
            localctx.id = self.match(GeneralizedListParser.IDENTIFIER)
            self.state = 14
    ...
    def value(self):
        ...
        try:
            ...
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << GeneralizedListParser.INTEGER) | (1 << GeneralizedListParser.FLOAT) | (1 << GeneralizedListParser.SPECIAL_KEYWORD) | (1 << GeneralizedListParser.STRING))) != 0)):
                localctx.id = self._errHandler.recoverInline(self)
            else:
    ...
    def variable(self):
        ...
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 31
            localctx.id = self.match(GeneralizedListParser.VARIABLE)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
